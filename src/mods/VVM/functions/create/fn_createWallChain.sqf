/*	fn_createWallChain.sqf - Sa-Matra - Function creates chain of objects (walls) from specific pos with supplied array of relative angles.
	Example: _walls = ["Land_fort_bagfence_long", 1.5, getPos player, [0, 90, 90]] execVM "fn_createWallChain.sqf";
	Parameter(s):

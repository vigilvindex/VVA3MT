...
_flashHider = "";
_silencer1 = "muzzle_snds_58_hex_F"; // 6.5 silencer (black)
_silencer2 = "muzzle_snds_H"; // .338 silencer (black)
_silencerdm = "muzzle_snds_65_TI_hex_F"; // 7.62 silencer (black)
...
{	
	...
	case "rsl":
	{
		...
		_unit addMagazines [_grenade,2];
		_unit addMagazines [_smokegrenade,3];
		_unit addMagazines [_smokegrenadealt,3];
		_unit addMagazines [_chem,2];
		_unit addMagazines [_pistolmag,2];
		[_unit, _pistol] call f_fnc_addWeapon;
		[_unit, _binos2] call f_fnc_addWeapon;

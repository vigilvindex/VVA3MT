...
// ATTACHMENTS
// ================================
_scope_frontline = ["optic_ACO", "optic_Holosight_blk_F"]; // Standard choice for infantry - give them the chance for med range.
_scope_support = ["optic_ACO", "optic_Holosight_blk_F"]; // Support infantry don't get extra options
_scope_dm = ["optic_KHS_old"]; // Designated Marksman Night
...
_attach_mg = [_attach1, _bipod1]; // MMG
_attach_ar = [_attach1, _bipod1];	// Autorifle
_attach_dm = [_attach1, _scope_dm, _bipod1];		// Designated Marksman
_attach_sp = [];			// "Support" Roles
...
_rifle = ["arifle_TRG21_F", "arifle_Mk20_F"];
...
// Infantry
_bagsmall 	= 		["B_AssaultPack_rgr", "B_AssaultPack_dgtl", "B_AssaultPack_cbr"];
_bagmedium 	= 		["B_TacticalPack_oli", "B_TacticalPack_rgr"];
_bagday 	=		["B_Kitbag_cbr", "B_Kitbag_rgr"];
...
_baseUniform = ["U_IG_Guerilla2_1", "U_IG_Guerilla2_2", "U_IG_Guerilla2_3", "U_IG_Guerrilla_6_1", "U_IG_Guerilla1_1", "U_IG_leader"];
_baseHelmet = ["H_Booniehat_oli", "H_Booniehat_dgtl", "H_Watchcap_blk", "H_Beret_blk", "H_Bandanna_cbr", "H_Cap_grn", "H_Cap_blk", "H_Bandanna_khk", "H_Booniehat_khk", "H_Watchcap_cbr", "H_Watchcap_khk", "H_Watchcap_camo", "H_Shemag_olive"];
_baseGlasses = ["", "G_Shades_Black", "G_Sport_Blackred", "G_Shades_Red", "G_Shades_Blue", "G_Shades_Green", "G_Bandanna_blk", "G_Bandanna_oli", "G_Bandanna_khk", "G_Bandanna_tan", "G_Bandanna_shades", "G_Bandanna_sport", "G_Bandanna_aviator", "G_aviator"];

// Vests
_vlightReg = "V_Chestrig_rgr";
_lightRig = "V_Chestrig_rgr";
_mediumRig = ["V_PlateCarrierIA1_dgtl", "V_TacVest_oli", "V_Chestrig_rgr", "V_TacVest_khk", "V_Chestrig_khk"]; 	// default for all infantry classes
_heavyRig = "V_TacVest_oli";
_specialRig = "V_TacVest_oli";

// Lighter / Support Objects
_lightHelmet = _baseHelmet;
_lightUniform = _baseUniform;

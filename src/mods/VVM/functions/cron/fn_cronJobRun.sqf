/* Function: VVM_fnc_cronJobRun; - Authors: longbow - License: MIT License - https://github.com/ussrlongbow/VVM_cron
 * Version: 1.0 - Dependencies: VVM_fnc_cronJobAdd, VVM_fnc_cronJobRemove, VVM_var_cronDebug, VVM_var_cronSchedule
 * Description: Runs jobs from VVM_var_cronSchedule if time > jobs' execution time. Executed on server.

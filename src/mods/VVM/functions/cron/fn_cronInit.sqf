...
if (isServer) then {
	...
	VVM_var_cronDebug = true; // Writes debug information to logs, make sure allowFunctionsLog enabled in mission's description.ext. Set to false for production release.
};

// Usage: [["TEXT1","<t align = 'center' shadow = '1' size = '1.0'>%1</t><br/>"],["0500, ALTIS","<t align = 'center' shadow = '1' size = '0.7'>%1</t><br/>"]] call VVM_fnc_displayText;
...
{   _blockArray = _x;
    ...
    _processedTextF  = _processedTextF + _blockTextF; // store finished block
} forEach _blocks; // do the printing
["",0,0.15,5,0,0,90] spawn BIS_fnc_dynamicText; // clean the screen

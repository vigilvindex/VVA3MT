/* Function: GKB_bordersToMapLocal - Author: Gekkibi - Licence: http://creativecommons.org/licenses/by-nc-sa/3.0/
 * Description: Simulates authentic map by not showing the entire map.
 * Example: [[5800,5400],[sqrt 2 * 2000,2000]] call GKB_fnc_bordersToMapLocal;
 * Returns: Nil
 * Parameters:

/* Function: GKB_fnc_arrowToMapLocal - Author: Gekkibi - Licence: http://creativecommons.org/licenses/by-nc-sa/3.0/
 * Description:	Draws an arrow locally to the map. Optional text inside the arrow.
 * Dependencies: GKB_fnc_lineToMapLocal, GKB_fnc_textToMapLocal (optional).
 * Example: _markerArray = [[2500,3000],[45,600,50,5],["ColorGreen",1],["advance!","front","ColorBlue",1]] call GKB_fnc_arrowToMapLocal;

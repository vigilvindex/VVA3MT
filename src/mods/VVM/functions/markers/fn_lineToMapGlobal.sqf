/* Function: GKB_fnc_lineToMapGlobal - Author: Gekkibi - Licence:  http://creativecommons.org/licenses/by-nc-sa/3.0/
 * Description: Draw lines globally to the map.
 * Example: _markerArray = [[[1200,3000],[1600,2800],[1500,3000]],5,["ColorRed",1]] call GKB_fnc_drawToMapGlobal;

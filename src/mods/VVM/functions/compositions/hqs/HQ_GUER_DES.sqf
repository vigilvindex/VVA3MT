...
_composition = [
	["B_supplyCrate_F",[-3,2,0.5],360,1,0,[0,0],"VVM_AI_I_AMMOBOX1","",true,false], 
	["Land_HelipadSquare_F",[-29,-14,0],360,1,0,[0,0],"VVM_AI_I_HELIPAD1","",true,false], 
	["Land_RepairDepot_01_tan_F",[-13,-4,0.5],270,1,0,[0,0],"VVM_AI_I_GARAGE1","",true,false], 
	["Flag_AAF_F",[-3,-1,0],360,1,0,[0,0],"VVM_AI_I_FLAGPOLE1","",true,false], 
	["Land_Cargo_House_V3_F",[-11.7263,12.2719,0],360,1,0,[0,0],"VVM_AI_I_SPAWN1","",true,false], 
	["Land_Cargo_House_V3_F",[-20.1063,12.0718,0],360,1,0,[0,0],"VVM_AI_I_SPAWN2","",true,false], 
	["Land_Cargo_House_V3_F",[-28.5163,11.5818,0],360,1,0,[0,0],"VVM_AI_I_SPAWN3","",true,false], 
	["Land_Cargo_House_V3_F",[-36.8363,11.6618,0],360,1,0,[0,0],"VVM_AI_I_SPAWN4","",true,false], 
	["Land_Cargo_House_V3_F",[-45.6863,11.2018,0],360,1,0,[0,0],"VVM_AI_I_SPAWN5","",true,false], 
	["Land_Cargo_House_V3_F",[-58.4063,-27.7482,0],270,1,0,[0,0],"VVM_AI_I_SPAWN9","",true,false], 
...
_boxmarker = [_box,10,["ColorGreen",1]] call VVM_fnc_lineToMapGlobal;
_pos = _box select 0;
_boxtext = [[(_pos select 0) + 12 ,(_pos select 1)],[0,0.3],["INDEPENDENT HQ","ColorWhite",1]] call VVM_fnc_textToMapGlobal;
// Garage
VVM_AI_I_GARAGE1 allowDamage false; VVM_AI_I_GARAGE1 setPos (getPos VVM_AI_I_GARAGE1);
VVM_AI_I_HELIPAD1 allowDamage false;
_marker = [["n","VVM_AI_I_HELIPADMARKER1"],["p",(getPos VVM_AI_I_HELIPAD1)],["a",0],["ty",0]] call VVM_fnc_createMarker;
[VVM_AI_I_GARAGE1,["Garage",VVS_fnc_openVVS,["VVM_AI_I_HELIPADMARKER1","All"]]] remoteExec ["addAction",0,true];
_garpos = getPos VVM_AI_I_GARAGE1;
_garbox = [["p",[_garpos]],["m",0.5]] call VVM_fnc_getBoundingBox;
_garboxmarker = [_garbox,0.5,["ColorGreen",1]] call VVM_fnc_lineToMapGlobal;
...
// Ammobox
VVM_AI_I_AMMOBOX1 allowDamage false; VVM_AI_I_AMMOBOX1 setPos (getPos VVM_AI_I_AMMOBOX1);
[VVM_AI_I_AMMOBOX1,["Arsenal",{["Open",true] call BIS_fnc_arsenal;}]] remoteExec ["addAction",0,true];
_ammopos = getPos VVM_AI_I_AMMOBOX1;
_ammobox = [["p",[_ammopos]],["m",0.5]] call VVM_fnc_getBoundingBox;
_ammoboxmarker = [_ammobox,0.5,["ColorGreen",1]] call VVM_fnc_lineToMapGlobal;
...
// Flag Teleport & Halo
VVM_AI_I_FLAGPOLE1 allowDamage false;
[VVM_AI_I_FLAGPOLE1,["Halo Jump",{}]] remoteExec ["addAction",0,true];
[VVM_AI_I_FLAGPOLE1,["Teleport",{}]] remoteExec ["addAction",0,true];
_flagpos = getPos VVM_AI_I_FLAGPOLE1;
_flagbox = [["p",[_flagpos]],["m",0.5]] call VVM_fnc_getBoundingBox;
_flagboxmarker = [_flagbox,0.5,["ColorGreen",1]] call VVM_fnc_lineToMapGlobal;

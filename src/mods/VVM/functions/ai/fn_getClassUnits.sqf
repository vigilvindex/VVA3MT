/* Name: vv_fnc_get_classname_units.sqf
 * Description: Returns an array of classnames for units.
 ...
 * Example: _units = [FALSE,"east","opfor","army","man","infantry"] call VVM_fnc_getClassUnits;
 * TODO:

...
_attach1 = ["acc_flashlight"]; // NVGs disabled - they get torches instead
_attach2 = "";
...
_scope_dm = ["optic_SOS", "optic_AMS", "optic_DMS"]; // Designated Marksman
_scope_sniper = ["optic_AMS", "optic_DMS", "optic_LRPS"]; // Sniper
...
_attach_mg = [_attach1, _scope_frontline, _bipod1, _silencer2];
_attach_ar = [_attach1, _scope_frontline, _bipod1, _silencer1];
_attach_dm = [_attach1, _scope_dm, _bipod1, _silencerdm];
...
// FACE, CLOTHES AND UNIFORMS
_light = ["co", "m", "leng", "mtrg", "mtrag", "hsamag", "hsamg", "msamag", "msamg", "jtac", "mmg", "mmgag", "matag", "matg"];
_heavy =  ["engm"];
_diver = ["div"];
_pilot = ["pp","pcc","pc"];
_crew = ["vc","vg","vd"];
...
// _baseUniform = _baseUniform = ["U_B_CTRG_1", "U_B_CTRG_3"]; REMOVE COMMENT TO NOT ALLOW TSHIRTS

// _baseHelmet = ["H_HelmetSpecB_snakeskin"];
_baseHelmet = ["H_HelmetB_camo"]; // CAMO VARIANT

// _lightHelmet = "H_HelmetB_light_snakeskin";
_lightHelmet = "H_HelmetB_camo"; // CAMO VARIANT

_baseGlasses = ["", "G_Combat", "G_Tactical_Clear", "G_Lowprofile", "G_Shades_Black", "G_Sport_Blackred", "G_Shades_Red", "G_Shades_Blue", "G_Shades_Green", "G_Tactical_Black"];

// Vests
_lightRig = "V_PlateCarrierL_CTRG";
_mediumRig = "V_PlateCarrierH_CTRG"; 	// default for all infantry classes
...
if (_isMan) then {
	...
	_unit addItem "H_Booniehat_khk_hs";// Free Hat!
};

...
_scope_dm = ["optic_AMS", "optic_SOS", "optic_Hamr"]; // Designated Marksman Night
...
_flashHider = "";
_silencerStd = "muzzle_snds_H"; // 6.5 silencer (black)
_silencerAr = "muzzle_snds_H"; // 6.5 silencer (black)
...
_specialRig = "V_PlateCarrierH_CTRG";

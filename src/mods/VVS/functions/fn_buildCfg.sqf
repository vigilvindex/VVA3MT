...
// FOR EXAMPLE, YOU WANT TO ADD CLASS "AIR2" TO AIR VEHICLE SPAWNER. ADD IT ON LINE 83 RIGHT AFTER "rhs_vehclass_helicopter".
		...
		// ARMORED (TANKS, APC, IFV, ARTILLERY)
					if ((count VVS_Armored == 0) && (_vehicleClass in ["Armored","gm_vc_prototype","gm_vc_armor_oli","rhs_vehclass_tank","rhs_vehclass_apc","rhs_vehclass_ifv","rhs_vehclass_artillery"])) then

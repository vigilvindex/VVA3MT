_key = "MXSW"; // https://armedassault.fandom.com/wiki/MX_series
...
_variants = [
	"arifle_MX_SW_Black_F", // 0 LSW Black
	"arifle_MX_SW_F", // 1 LSW Sand
	"arifle_MX_SW_khk_F" // 2 LSW Khaki
];
_magazines = [
	"100Rnd_65x39_caseless_black_mag", // 0 Black
	"100Rnd_65x39_caseless_mag", // 1 Sand
	"100Rnd_65x39_caseless_khaki_mag" // 2 Khaki
];
_tracers = [
	"100Rnd_65x39_caseless_black_mag_tracer", // 0 Black
	"100Rnd_65x39_caseless_mag_Tracer", // 1 Sand
	"100Rnd_65x39_caseless_khaki_mag_tracer" // 2 Khaki
];
_grenades = [];
_flares = [];
_smokes = [];
